...
namespace forest
{
    public class PlayfieldEditorUISelectable : MonoBehaviour
    {
        ...
        public PlayfieldEditorSelectionType SelectableType { get; private set; }
        ...
        public void SetData(GameObject visual, PlayfieldEditorSelectionType type, string tag, System.Action<PlayfieldEditorUISelectable> onClick)
        {
            this.Visual = visual;
